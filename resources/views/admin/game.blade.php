  ...
  <div class="flex pt-24 pb-5">
    <div class="grid bg-zinc-900 rounded-lg shadow-xl mx-auto sm:w-11/12 w-7/12">
      ...
      <div class="flex justify-center">
        <div class="flex">
          <h1 class="text-gray-400 font-bold md:text-2xl text-xl">Upload Game</h1>
        </div>
      </div>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Upload game
            replay</label>
          <input
            class="mt-1 block w-full text-sm border-2 text-gray-400 rounded-lg focus:ring-2 bg-neutral-900 border-purple-300 cursor-pointer focus:outline-none"
            id="game-replay" type="file" accept="application/json" required name="replay">
        </div>

        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 1</label>
          <input
        ...
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 2</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban2" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 3</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban3" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 4</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban4" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 5</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban5" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 6</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban6" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 7</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban7" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 8</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban8" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 9</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
            type="text" list="champions" placeholder="Champion name" required name="ban9" />
        </div>
        <div class="grid grid-cols-1 mt-3 mx-7">
          <label class="uppercase md:text-sm text-xs text-gray-400 text-light font-semibold">Ban 10</label>
          <input
            class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 bg-neutral-900"
