    ...
    <div class="grid bg-zinc-900 rounded-lg shadow-xl w-min mx-auto 3xl:w-11/12">
        ...
        <div
            ...
            <div class="mt-4 w-full">
                <span class="text-2xl font-bold text-blue-600">Blue Team @if($summonerMatches[0]->didWin)
                        won
                    @endif</span>
                ...
                @foreach($summonerMatches as $key=>$summonerMatch)
                    @if($key < 5)
                        <div class="grid grid-cols-9 ml-2 mt-2 gap-1 text-gray-400">
                            ...
                            <div>
                                <h2 class="px-0.5 text-xl font-semibold">
                                    <a class="hover:text-gray-200 flex flex-row"
                                       href="/champion/{{$summonerMatch->champion->name}}">
                                        <img class="w-6"
                                             src="{{url('../img/' . $summonerMatch->champion->getChampionImgName() . '.png')}}"/>
            ...
            <div class="mt-4 w-full">
                <span class="text-2xl font-bold text-red-600">Red Team @if($summonerMatches[5]->didWin)
                        won
                    @endif</span>
